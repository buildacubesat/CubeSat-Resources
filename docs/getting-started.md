...
- [NASA's CubeSat Launch Initiative Resources](https://www.nasa.gov/kennedy/launch-services-program/cubesat-launch-initiative/cubesat-launch-initiative-resources/): A list of documents and websites that covers everything needed when starting a CubeSat project. 
...
- To keep up to date with the space industry at large, subscribing to a few [relevant newsletters](references/newsletters.md) is recommended.
