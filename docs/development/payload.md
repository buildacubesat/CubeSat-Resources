...
[^ccsds122]: Consultative Committee for Space Data Systems, [*Image Data Compression*, CCSDS 122.0-B-2](https://ccsds.org/Pubs/122x0b2e1.pdf), Recommended Standard Issue 2, September 2017. Free PDF. Applies to two-dimensional digital spatial image data from spacecraft instruments, covering frame-based formats from CCD arrays and strip-based formats from push-broom sensors, and states that the technique "can be used to produce both lossy and lossless compression".

[^ccsds123]: Consultative Committee for Space Data Systems, [*Low-Complexity Lossless and Near-Lossless Multispectral and Hyperspectral Image Compression*, CCSDS 123.0-B-2](https://ccsds.org/Pubs/123x0b2e2c3.pdf), Recommended Standard Issue 2, February 2019, incorporating Technical Corrigendum 3 (February 2021) and subsequent editorial changes. Free PDF. Defines lossless and near-lossless compression for three-dimensional multispectral and hyperspectral arrays, in "a way that the maximum error in the reconstructed image can be limited to a user-specified bound", with three entropy coding options (sample-adaptive, hybrid and block-adaptive).