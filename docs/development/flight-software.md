...
- **Uplink in verified chunks**, with per-chunk checksums and the ability to resume. A 200 kB image over a 9600 bps link across a 10-minute pass will not arrive in one go.
...
- **[libcsp on GitHub](https://github.com/GOMspace/libcsp)** `Link` – MIT-licensed CSP source, running on FreeRTOS, Zephyr and Linux
