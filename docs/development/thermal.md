...
- **Direct solar** – the dominant term. The measured [solar constant](../references/glossary.md#solar-constant) is **about 1361 W/m²** at 1 AU.[^tsi] NASA's preferred-practice guidance works from a nominal **1367.5 W/m²**, varying seasonally by about ±3.5% as Earth's distance from the Sun changes, and puts the recommended hot and cold design values at the ends of that swing: **1422 W/m² at perihelion** (northern winter) and **1318 W/m² at aphelion**, each 4.0% from nominal.[^gsfc-2301][^tfaws-environments] The 6 W/m² between the two nominal figures is under half a percent and well inside the seasonal variation, so it does not move a design case – but quote the value you used.
...
[^tsi]: Greg Kopp and Judith L. Lean, ["A new, lower value of total solar irradiance: Evidence and climate significance"](https://doi.org/10.1029/2010GL045777), *Geophysical Research Letters* 38(1), L01706, 2011, doi:10.1029/2010GL045777. Paywalled. Reports the most probable total solar irradiance at solar minimum as 1360.8 ± 0.5 W/m², measured by the Total Irradiance Monitor on NASA's SORCE, against the 1365.4 ± 1.3 W/m² value established in the 1990s; attributes the earlier, higher figures to scattered light in the previous generation of radiometers.
