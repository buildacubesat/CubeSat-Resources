...
Nor do one manual's allowances transfer to another. XTERRA's XCD guide allows **6.50 kg for a 3U and 13.00 kg for a 6U** – roughly 2.17 kg per U, above the CDS and below Nova.[^xcd-guide] Two published manuals, two different numbers, both more generous than the specification and neither a substitute for the other.
...
Deployer manuals restate these limits in their own terms, and not always identically. XTERRA's XCD guide recommends ±20 mm on all three axes for a 1U, ±20/±20/±70 mm for a 3U and ±20/±45/±70 mm for a 6U, scaling the Z allowance roughly linearly with satellite length between 113.5 mm and 366 mm.[^xcd-guide] Two things follow. Convert into a common frame before comparing numbers: the guide defines its axes on the dispenser rather than on the satellite, which is why its 6U X and Y allowances read as the transpose of the CDS table's. And note the modal verb: the CDS states a requirement, while the XCD guide states a recommendation and accepts larger offsets after review. A figure that looks like a hard limit in one document can be a review trigger in another, which is worth establishing before you spend mass on balancing.
...
[^xcd-guide]: XTERRA, *XCD-3U/6U Hybrid User's Guide*, document XTD-100084 Revision 1.3.3, 21 January 2026, available from [xterra.space](https://www.xterra.space/products). Free PDF. Section 4.1 gives maximum satellite masses of 2.17 kg for 1U, 6.50 kg for 3U and 13.00 kg for 6U against maximum lengths of 113.5 mm, 227 mm and 366 mm rail end to rail end. Section 4.4 gives center-of-gravity offset limits of ±20 mm on all axes for 1U, ±20/±20/±70 mm for 3U and ±20/±45/±70 mm for 6U, notes that the offset scales roughly linearly in Z with satellite length, and states that satellites exceeding these values remain compatible but must be reviewed. Note that the guide's coordinate frame is defined on the dispenser (Figures 1–3, aft Z− and front Z+) rather than on the satellite, so its axis labels are not interchangeable with those of the CDS table. Section 5.1 gives empty dispenser masses of 7.25 kg in the 3U configuration and 6.50 kg in the 6U.
