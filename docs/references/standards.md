...
A CubeSat flying as a secondary payload is rarely held to either. Read them anyway: they are specific about wetting, fillet shape and disturbed joints in a way no tutorial is, and they are what an inspector at a partner organization will be applying. They also carry requirements that are easy to miss until they bite – the addendum's [red plague](glossary.md#red-plague) control plan for silver-plated copper conductors, for one. Technique itself is covered on [Tools – Soldering and rework](../development/tools.md#soldering-and-rework).
