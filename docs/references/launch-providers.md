...
That list is not guesswork. Arrow Science and Technology's space logistics quote form asks for exactly it – target launch window, target orbit with altitude and inclination, payload size, whether the payload carries propulsion, whether it has batteries and of what size, whether it has deployable appendages, and the readiness date.[^arrow-logistics] Expect the same questions from anyone else, and expect the three hazard questions to drive the rest of the conversation.
...
How much a broker publishes before you talk to them varies more than the services do. Most quote nothing at all. RIDE! runs a self-service platform you can register on directly, and has held brokerage contracts on Vega-C and SpaceX since 2022 alongside framework agreements with Arianespace, Exotrail, CAS Space, Agnikul and Momentus.[^ride] At the hardware end, Arrow's XTERRA dispensers carry published list prices – from $44,750 for the convertible 1U–6U unit and $89,750 for the 12U/16U – which is rare enough to be worth knowing when you are trying to put a number against the deployer line, and their user guides are openly available in the way Exolaunch's are.[^xterra]
...
- **[RIDE!](https://www.ridespace.io/)** `Link` – French broker and mission-planning platform, brokering on Vega-C, SpaceX and a range of other launchers and orbital transfer vehicles. Registration opens a self-service tool for comparing launch opportunities, so the first step can be a search rather than an email
...
- **[Arrow Science and Technology](https://www.arrowscitech.com/space-logistics)** `Link` – US mission integrator taking a turnkey approach: selecting the launch opportunity, writing the requirements, manifesting the payload and integrating it to the vehicle. Its XTERRA division builds the XCD CubeSat dispensers, user-convertible across 1U to 6UXL and 12U to 16U without mass model spacers, with openly published user guides and list prices
...
[^arrow-logistics]: Arrow Science and Technology, [*Space Logistics*](https://www.arrowscitech.com/space-logistics). Free. Describes a turnkey service covering launch opportunity selection, requirements definition, test and flight support equipment, manifesting and payload integration to the launch vehicle. Its published quote form is the source for the intake fields listed above: target launch window, target orbit with altitude and inclination, payload size, propulsion, battery presence and size, deployable appendages, and payload readiness date.

[^xterra]: XTERRA, [*Products*](https://www.xterra.space/products) (page revisions dated 21 January 2026). Free. Arrow's own site mirrors this page at `arrowscitech.com/xterraproducts`, with two discrepancies – it calls the dispenser patented where XTERRA says patent-pending, and it gives the 12U/16U price basis as a 6U configuration where XTERRA says 16U. Prefer the XTERRA page. The XCD-3U/6U Hybrid is listed from $44,750 based on a standard 6U configuration, user-convertible across 1U, 2U, 3U and 6UXL in a single system without mass model spacers and combinable in pairs into a Quadpack-equivalent arrangement; the XCD-12U/16U Hybrid is listed from $89,750 and accepts satellites from 227 mm to 454 mm in length. User guides for both are published as free PDFs, and custom deployment systems are offered. List prices, not quotations.

[^ride]: RIDE!, [*About RIDE!*](https://www.ridespace.io/about). Free. Company timeline giving first platform prototype and a CNES contract in 2021, first brokerage contracts on Vega-C and SpaceX in 2022, and a first ESA contract in 2023 alongside framework agreements with Arianespace, Exotrail, CAS Space, Agnikul and Momentus. A self-published corporate source; the contract counts and network figures are the company's own and have not been independently checked.
